...
<head>
    ...
    <link rel="icon" href="./image/icons8-youtube.gif">
    ...
    <div class="container">
        <form method="post" action="" class="formSmall">
            <div class="row">
                ...
                <a href="https://www.youtube.com/channel/UCC_Adr2qlJWSiS-Ef3XOwbA" target=".blank"><img src="image/icons8-youtube.gif" class="rounded mx-auto d-block" alt="icons8-youtube.gif" ></a>
                ...
                <div class="col-lg-12">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="video_link" placeholder="Paste link.. e.g. https://www.youtube.com/watch?v=_fqJDBtKQIc">
                        <span class="input-group-btn">
                        <button type="submit" name="submit" id="submit" class="btn btn-danger">Go!</button>
                      </span>
                    </div><!-- /input-group -->
                </div>
            </div><!-- .row -->
